    ...
    <div class="container-d" id="container">
        ...
        <div class="middle-body">
            <div class="details-body">
                <form method="POST" action="/delete/{{$blog->id}}" class="edit-box">
                    @csrf
                    @method('DELETE')
